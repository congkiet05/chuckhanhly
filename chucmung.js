...
const messages = [
    'Chúc Khánh Lì có một ngày 20/10 thật hạnh phúc và tràn đầy niềm vui!',
    'Chúc Khánh Lì luôn xinh đẹp, tự tin và yêu đời!',
    'Mong Khánh Lì luôn mạnh mẽ, thành công và yêu thương bản thân mình!',
    'Chúc Khánh Lì một ngày 20/10 thật ngọt ngào và đáng nhớ!',
    'Chúc Khánh Lì luôn toả sáng và đạt được mọi ước mơ trong cuộc sống!',
];
